...
// - 3·1절/광복절/개천절/한글날/어린이날/부처님오신날/설날·추석/크리스마스: 토·일요일과
//   겹치면 대체공휴일 적용 (단, 설날·추석은 일요일과 겹칠 때만 적용). 크리스마스는 2023년
//   법 개정으로 부처님오신날과 함께 대체공휴일 적용 대상에 추가됨(보스 리뷰에서 발견 — 기존
//   주석은 개정 전 규칙 기준으로 잘못돼 있었음).
// - 신정, 현충일: 대체공휴일 미적용.
...
export const HOLIDAYS: Holiday[] = [
  ...
  { date: '2027-12-27', name: '크리스마스', isSubstitute: true }, // 12/25가 토요일이라 대체공휴일 적용(2023년 개정)
]
